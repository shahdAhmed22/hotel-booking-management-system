...
`
export const forgetPasswordEmailTemplete=`
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Reset Your Password - Royal Haven</title>
    <style>
        /* Global Styles */
        body {
            font-family: 'Arial', sans-serif;
...
<body>
    <div class="container">
        <div class="email-content">
            ...
            <div class="message">
                <p>Hi [User Name],</p>
                <p>We received a request to reset your password for your Royal Haven account.</p>
                <p>Click the button below to reset your password:</p>
                <a href="[Reset Password Link]" class="cta-button">Reset Password</a>
